...
int win32_dlgproc_dynamicmovement(HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM) {
    ...
    switch (uMsg) {
        case WM_INITDIALOG:
            ...
            if (g_this->rectcoords) CheckDlgButton(hwndDlg, IDC_CHECK3, BST_CHECKED);
            if (g_this->wrap) CheckDlgButton(hwndDlg, IDC_WRAP, BST_CHECKED);
            if (g_this->nomove) CheckDlgButton(hwndDlg, IDC_NOMOVEMENT, BST_CHECKED);
            ...
            SendDlgItemMessage(
                hwndDlg, IDC_COMBO1, CB_SETCURSEL, (WPARAM)g_this->buffern, 0);
        ...
        case WM_COMMAND:
            ...
            if (LOWORD(wParam) == IDC_BUTTON4) {
                ...
                if (x >= 16
                    ...
                    SetDlgItemInt(
                        hwndDlg, IDC_EDIT5, g_this->presets[x - 16].grid1, FALSE);
                    SetDlgItemInt(
                        hwndDlg, IDC_EDIT6, g_this->presets[x - 16].grid2, FALSE);
