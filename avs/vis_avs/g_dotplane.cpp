...
int win32_dlgproc_dotplane(HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    auto g_this = (E_DotPlane*)g_current_render;
    const Parameter& p_rotation_speed = DotPlane_Info::parameters[1];
    const Parameter& p_angle = DotPlane_Info::parameters[2];
    AVS_Parameter_Handle p_color = DotPlane_Info::color_params[0].handle;
