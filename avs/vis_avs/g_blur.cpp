    ...
    switch (uMsg) {
        ...
        case WM_COMMAND: {
            ...
            switch (control) {
                ...
                case IDC_RADIO2: g_this->set_int(p_level, 1); break;
                case IDC_RADIO3: g_this->set_int(p_level, 0); break;
                case IDC_RADIO4: g_this->set_int(p_level, 2); break;
                case IDC_ROUNDUP: g_this->set_int(p_round, 1); break;
                case IDC_ROUNDDOWN: g_this->set_int(p_round, 0); break;
                default: break;
            }
            return 0;
        }
