...
enum Interferences_Blendmodes {
    INTERFERENCES_REPLACE = 0,
    INTERFERENCES_ADDITIVE = 1,
    INTERFERENCES_5050 = 2,
};
...
struct Interferences_Info : public Effect_Info {
    ...
    static constexpr Parameter parameters[num_parameters] = {
        ...
        P_FRANGE(offsetof(Interferences_Config, on_beat_speed),
                 ...
                 0.01,
                 1.28),
        P_SELECT(offsetof(Interferences_Config, blend_mode), "Blend Mode", blend_modes),
    };
